 ...
 * holds an immutable reference to the entry_point
...
contract EIP4337Manager is IAccount, GnosisSafeStorage, Executor {
    ...
    external override returns (uint256 validationData) {
        ...
        if (missingAccountFunds > 0) {
            ...
            (success);
            //ignore failure (its entry_point's job to verify, not account.)
        }
    }
     ...
     * entry_point wouldn't know to emit the UserOperationRevertReason event,
    ...
    /**
     * replace EIP4337 module, to support a new entry_point.
     ...
     * @param newManager the new EIP4337Manager, usually with a new entry_point
     */
    ...
    /**
     * Validate this gnosisSafe is callable through the entry_point.
